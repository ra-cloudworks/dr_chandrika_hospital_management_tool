    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('chief_doctor', 'Chief Doctor'), ('doctor', 'Doctor'), ('assistant', 'Assistant'), ('receptionist', 'Receptionist'), ('accountant', 'Accountant'), ('patient', 'Patient')], max_length=20)),
